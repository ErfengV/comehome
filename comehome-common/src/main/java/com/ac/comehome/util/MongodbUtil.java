...
public class MongodbUtil {
    ...
    public static void updateFirst(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
        ...
        mongodbUtil.mongoTemplate.updateFirst(query, update, collectionName);
    }
    ...
    public static void updateMulti(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
        ...
        mongodbUtil.mongoTemplate.updateMulti(query, update, collectionName);
    }
    ...
    public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues) {
        ...
        Query query = Query.query(criteria);
        List<? extends Object> resultList = mongodbUtil.mongoTemplate.find(query, obj.getClass());
        return resultList;
    }
    ...
    public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues, String collectionName) {
        ...
        Query query = Query.query(criteria);
        List<? extends Object> resultList = mongodbUtil.mongoTemplate.find(query, obj.getClass(), collectionName);
        return resultList;
    }
    ...
    public static Object findOne(Object obj, String[] findKeys, Object[] findValues) {
        ...
        Query query = Query.query(criteria);
        Object resultObj = mongodbUtil.mongoTemplate.findOne(query, obj.getClass());
        return resultObj;
    }
    ...
    public static Object findOne(Object obj, String[] findKeys, Object[] findValues, String collectionName) {
        ...
        Query query = Query.query(criteria);
        Object resultObj = mongodbUtil.mongoTemplate.findOne(query, obj.getClass(), collectionName);
        return resultObj;
    }
    ...
    public static List<? extends Object> findAll(Object obj) {
        ...
        List<? extends Object> resultList = mongodbUtil.mongoTemplate.findAll(obj.getClass());
        return resultList;
    }
    ...
    public static <T> List<T> findAll(Class<T> clazz) {
        List<T> resultList = mongodbUtil.mongoTemplate.findAll(clazz);
        return resultList;
    }
    ...
    public static List<? extends Object> findAll(Object obj, String collectionName) {
        ...
        List<? extends Object> resultList = mongodbUtil.mongoTemplate.findAll(obj.getClass(), collectionName);
        return resultList;
    }
    ...
    public static <T> List<T> findAll(Class<T> clazz, String collectionName) {
        List<T> resultList = mongodbUtil.mongoTemplate.findAll(clazz, collectionName);
        return resultList;
    }
